...
class cycleGANsim2real():
    def __init__(self, ckpt_name, input_nc=3, preprocess="resize_and_crop"):
        ...
        if input_nc != 3:
            sys.argv.append("--input_nc")
            sys.argv.append(str(input_nc))
            sys.argv.append("--output_nc")
            sys.argv.append(str(input_nc))
        if preprocess != "resize_and_crop":
            sys.argv.append("--preprocess")
            sys.argv.append(preprocess)
