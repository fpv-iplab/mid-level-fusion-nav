...
# DATA AUGMENTATION
#------------------------------------------------------------------------------
_C.USE_DATA_AUGMENTATION = False
_C.AUGM_PARAMS = CN()

_C.AUGM_PARAMS.BRIGHTNESS_MIN: 0.6
_C.AUGM_PARAMS.BRIGHTNESS_MAX: 2.0
_C.AUGM_PARAMS.COLOR_MIN: 0.5
_C.AUGM_PARAMS.COLOR_MAX: 2
_C.AUGM_PARAMS.CONTRAST_MIN: 0.7
_C.AUGM_PARAMS.CONTRAST_MAX: 2.0
_C.AUGM_PARAMS.SHARPNESS_MIN: 0.
_C.AUGM_PARAMS.SHARPNESS_MAX: 2.0
#-----------------------------------------------------------------------------
# HISTOGRAM EQUALIZATION
# ----------------------------------------------------------------------------
_C.EQUALIZE_IMAGES = False
#-----------------------------------------------------------------------------
# MIDLEVEL REPRESENTATIONS
# ----------------------------------------------------------------------------
_C.USE_MIDLEVEL_REPRESENTATION = False
_C.MIDLEVEL_PARAMS = CN()
_C.MIDLEVEL_PARAMS.ENCODER = "default"
_C.MIDLEVEL_PARAMS.USE_FEATURE_MAPS = False
#_C.MIDLEVEL_PARAMS.FEATURE_TYPE = ["keypoints3d"]
# ----------------------------------------------------------------------------
# EVAL CONFIG
# -----------------------------------------------------------------------------
_C.EVAL = CN()
